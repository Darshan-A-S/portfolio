// ponytail: `dasregistary` is a placeholder registry name; swap to the real package name when published
...
export function DatePicker({ label, value, onChange, error, disabled }: DatePickerProps) {
  ...
  usageImport: `import { DatePicker } from "@/components/date-picker"`,
