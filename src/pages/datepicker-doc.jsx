      ...
      <div className="mx-auto max-w-[768px] border-x border-[color:var(--color-border)]">
        ...
        <div className="border-b border-[color:var(--color-border)] px-4 py-6">
          ...
          <p className="mt-2 text-[14px] leading-relaxed text-[var(--color-text-muted)]">
            ...
            <Mono>onChange</Mono> in <Mono>YYYY-MM-DD</Mono>, with label, error, and disabled states.
          </p>
        </div>
        ...
        <Section title="Installation">
          ...
          {tab === "cli" ? (
            ...
            <ol className="space-y-6">
              <li>
                <StepLabel n={1}>Install the following dependencies</StepLabel>
                <p className="text-[13px] text-[var(--color-text-muted)]">
                  The component has no dependencies beyond <Mono>react</Mono> and <Mono>react-dom</Mono>.
                </p>
              </li>
              <li>
                <StepLabel n={2}>Copy and paste the following code into your project</StepLabel>
                <CodeBlock title="components/date-picker.tsx" code={doc.sourceCode} />
              </li>
              <li>
                <StepLabel n={3}>Style the component</StepLabel>
